...
async function fixAutoIncrement() {
  try {
    ...
    await sql.query(`CREATE SEQUENCE IF NOT EXISTS cleaned_vehicles_id_seq START WITH ${startValue}`);
    ...
    await sql.query(`ALTER SEQUENCE cleaned_vehicles_id_seq OWNED BY vehicles.id`);
